      ...
      <NavLeftDesktop currentPage='group' groupRoute={`/group/${groupInfo.id}`} setShowLogoutModal={setShowLogoutModal} />
            ...
            >
                ...
                >
                    ...
                    <Text type='p' textEng='Username' textKor='유저네임' customStyles='col-span-3 text-center text-gray-400' />
                    <Text type='p' textEng='Joined' textKor='존인 한 날' customStyles='col-span-3 text-center text-gray-400' />
                    <Text type='p' textEng='Post Count' textKor='포스트 캬운트' customStyles='col-span-3 text-center text-gray-400' />
