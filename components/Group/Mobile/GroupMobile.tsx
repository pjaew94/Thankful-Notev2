...
const GroupMobile:React.FC<IGroupMobile> = ({groupInfo, visitorInfo}) => {
    ...
    const [membersOrPosts, setMembersOrPosts] = useState<"posts" | "members">("posts");
    ...
    return (
        ...
        <div className='w-full overflow-x-hidden pt-20 pb-20'>
            ...
            <NavSideMobile setOpenSideNav={setOpenSideNav} openSideNav={openSideNav} setShowLogoutModal={setShowLogoutModal} currentPage="group" groupRoute={`/group/${groupInfo.id}`} />
            ...
            <motion.div className='flex flex-col py-10 px-10'
                ...
                custom={0.2}
            >
                <Text type='h1' textEng="Group" textKor="그룹" customStyles='font-normal text-gray-400 mb-5' />
                <Text type='h1Extra' textEng={groupInfo.name} textKor={groupInfo.name} customStyles='mb-10'/>
                <Text type='p' textEng={`❤️ Your group was created on ${dateConverted}.`} customStyles='mb-2' />
                ...
                {membersOrPosts === "posts" ? <div className=''>
                    {/* Post Template */}
                ...
                >
                    {/* Template */}
                <div className='grid grid-cols-12 gap-2 mb-3'>
                    <Text type='p' textEng='Name' textKor='이름' customStyles='col-span-3 text-center text-gray-400' />
                    <Text type='p' textEng='Joined' textKor='조인 날짜' customStyles='col-span-6 text-center text-gray-400' />
                    <Text type='p' textEng='Post #' textKor='게시물 수' customStyles='col-span-3 text-center text-gray-400' />
                </div>
