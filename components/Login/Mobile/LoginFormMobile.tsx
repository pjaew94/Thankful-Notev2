...
const LoginFormMobile: React.FC<ILoginFormMobile> = ({
  ...
  return (
    <div
      className={` flex flex-col px-10 pt-16 pb-24 absolute top-0 w-full ${deviceHeight} bg-gray-100 z-10 transition-all duration-500 ease-in-out md:justify-center md:items-center ${
